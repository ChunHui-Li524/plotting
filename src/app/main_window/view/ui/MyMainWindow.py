...
class Ui_MyMainWindow(object):
    def setupUi(self, MyMainWindow):
        ...
        self.gridLayout_3.addWidget(self.frameMeasure, 3, 0, 1, 1)
        self.framePlotGroup = QtWidgets.QFrame(self.centralwidget)
        ...
        self.gridLayout_3.addWidget(self.framePlotGroup, 0, 0, 1, 1)
